      ...
      <div className="min-h-screen bg-gray-950 flex flex-col items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center w-full max-w-sm">
          <div className="mb-8 flex flex-col items-center animate-fade-in">
            ...
            <p
              className={`transition-colors duration-300 h-6 ${error
          ...
          <div
            className={`h-8 mb-8 flex items-center justify-center transition-all ${error ? "animate-shake" : ""
              }`}
          >
            {isVerifying ? (
              ...
              <div className="flex gap-3">
                {[0, 1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
                    className={`rounded-full transition-all duration-300 ${i < currentPin.length
                        ? error
