...
const Items: React.FC = () => {
    const { items, vaults, categories, loadItems, loadVaults, loadCategories, updateItem, deleteItem, toggleFavorite, isLoading, typeFilter, setTypeFilter } = useItemStore();
