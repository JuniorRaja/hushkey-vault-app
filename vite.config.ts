    ...
    server: {
      ...
      headers: {
        "Content-Security-Policy":
          "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https: blob:; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.pwnedpasswords.com https://www.google.com https://lookup.binlist.net; frame-src blob:; frame-ancestors 'none'; base-uri 'self'; form-action 'self'",
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          ...
          icons: [
            {
              src: "/AppImages/hushkey-icon.png",
              sizes: "512x512",
              type: "image/png",
              purpose: "any",
            },
